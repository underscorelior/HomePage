...
function Countdown({ cds }: { cds: Countdown[] }) {
	...
	return (
		<div className="flex flex-col rounded-tl-lg border-l-2 border-t-2 border-neutral-600 bg-neutral-50 p-4 text-xl font-bold sm:fixed sm:bottom-0 sm:right-0 sm:max-w-[20%] dark:border-neutral-800 dark:bg-neutral-950">
			{countdowns.length == 0 ? (
